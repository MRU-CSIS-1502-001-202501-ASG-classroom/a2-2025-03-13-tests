...
public class BlueprintTests {
        ...
        public void new_blueprint_has_expected_height_targets(String contructorText,
                ...
                // Given a blueprint with height targets and blocked off spaces
                Blueprint blueprint = new Blueprint(contructorText);

                // When the height target of each space is found
                int actualR1C1Target = blueprint.heightTargetAt(1, 1);
                int actualR1C2Target = blueprint.heightTargetAt(1, 2);

                int actualR2C1Target = blueprint.heightTargetAt(2, 1);
                int actualR2C2Target = blueprint.heightTargetAt(2, 2);

                int actualR3C1Target = blueprint.heightTargetAt(3, 1);
                int actualR3C2Target = blueprint.heightTargetAt(3, 2);
        ...
        public void says_spaces_with_positive_height_targets_are_open(String contructorText,
                ...
                boolean actualR1C1IsOpen = blueprint.isOpenSpace(1, 1);
                boolean actualR1C2IsOpen = blueprint.isOpenSpace(1, 2);

                boolean actualR2C1IsOpen = blueprint.isOpenSpace(2, 1);
                boolean actualR2C2IsOpen = blueprint.isOpenSpace(2, 2);

                boolean actualR3C1IsOpen = blueprint.isOpenSpace(3, 1);
                boolean actualR3C2IsOpen = blueprint.isOpenSpace(3, 2);
        ...
        public void says_spaces_with_0_height_targets_are_prohibited(String contructorText,
                ...
                boolean actualR1C1IsProhibited = blueprint.isProhibitedSpace(1, 1);
                boolean actualR1C2IsProhibited = blueprint.isProhibitedSpace(1, 2);

                boolean actualR2C1IsProhibited = blueprint.isProhibitedSpace(2, 1);
                boolean actualR2C2IsProhibited = blueprint.isProhibitedSpace(2, 2);

                boolean actualR3C1IsProhibited = blueprint.isProhibitedSpace(3, 1);
                boolean actualR3C2IsProhibited = blueprint.isProhibitedSpace(3, 2);
